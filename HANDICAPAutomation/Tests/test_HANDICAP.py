...
from JobModule.job_advertisement_criteria import JobAdvertisementCriteria
from JobModule.job_restriction import JobRestriction
...
job_advertisement_publish = fixed_data.job_advertisement_publish
...
def test_handicap(edge_driver_func):
    ...
    if job_advertisement_id == job_id:
        ...
        #Adding Criteria for Shortlisting
        job_advertisement_criteria = JobAdvertisementCriteria(edge_driver_func)
        job_advertisement_criteria.click_add_button()
        time.sleep(1)
        job_advertisement_criteria.insert_all_text_fields('Aliquam et luctus libero. Nulla facilisi.', 10)
        time.sleep(1)
        job_advertisement_criteria.select_status('Mandatory')
        time.sleep(1)
        job_advertisement_criteria.click_add_row_button()
        time.sleep(1)
        job_advertisement_criteria.insert_all_text_fields2('Aliquam et luctus libero. Nulla facilisi.', 10)
        time.sleep(1)
        job_advertisement_criteria.select_status2('Mandatory')
        time.sleep(1)
        job_advertisement_criteria.click_save_button()
        time.sleep(3)
        print('\nSuccessfully added Candidate Criteria')

        #Publishing the Job Advertisement
        edge_driver_func.find_element(By.XPATH, job_advertisement_publish).click()


    else:
        print('Advertisement ID doesn\'t match in Job Advertisement - More Job Information')

    #Adding Job Restriction
    job_restriction = JobRestriction(edge_driver_func)
    job_restriction.open_job_restriction_page('https://test.jobs.hi-bd.org/admin/job-restriction')
    time.sleep(1)
    job_restriction.click_add_new_button()
    time.sleep(2)
    job_restriction.select_job_request_id(job_id)
    time.sleep(2)
    job_restriction.insert_all_text_fields('Aliquam et luctus libero. Nulla facilisi.',
                                           'Aliquam et luctus libero. Nulla facilisi.',
                                           'Aliquam et luctus libero. Nulla facilisi.',
                                           'Aliquam et luctus libero. Nulla facilisi.',
                                           'Aliquam et luctus libero. Nulla facilisi.',
                                           ...
                                           'Aliquam et luctus libero. Nulla facilisi.')
    time.sleep(1)
    job_restriction.click_save_button()
    time.sleep(3)
    print('\nSuccessfully added Job Restriction')
